      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultValue={formState.enteredValue?.acquisitionChannel.includes('google')}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="friend"
            defaultValue={formState.enteredValue?.acquisitionChannel.includes('friend')}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="other"
            defaultValue={formState.enteredValue?.acquisitionChannel.includes('other')}
          />
      ...
      <div className="control">
        <label htmlFor="terms-and-conditions">
          <input
            ...
            name="terms"
            defaultValue={formState.enteredValue?.terms}
          />I
